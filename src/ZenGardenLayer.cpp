...
bool ZenGardenLayer::init() {
      ...
      m_diamondShards = Mod::get()->setSavedValue<int>("money", getShards);
      ...
      m_starCount = Mod::get()->getSavedValue<int>("stars", -1);
      m_moonCount = Mod::get()->getSavedValue<int>("moons", -1);
      m_diamondCount = Mod::get()->getSavedValue<int>("diamonds", -1);
      m_diamondShards = Mod::get()->getSavedValue<int>("money");
      ...
      topBarMenu->setPosition({0, 0});
      this->addChild(topBarMenu);

      auto topBarBG = CCScale9Sprite::create("square02_001.png");
      topBarBG->setContentSize({163, 40});
      topBarBG->setPosition({windowSize.width / 2 - 140, windowSize.height - 30});
      topBarBG->setOpacity(150);
      topBarBG->setID("top-bar-bg");
      topBarMenu->addChild(topBarBG);

      m_feedOrbsButton = CCMenuItemSpriteExtra::create(
      ...
      m_feedOrbsButton->setID("feed-orbs");
      m_feedOrbsButton->setPosition(topBarBG->getPositionX() - 60, topBarBG->getPositionY());
      topBarMenu->addChild(m_feedOrbsButton);

      m_orbsHoverSprite = CCSprite::createWithSpriteFrameName("currencyOrbIcon_001.png");
      m_orbsHoverSprite->setVisible(false);
      m_orbsHoverSprite->setID("orbs-hover");
      m_orbsHoverSprite->setZOrder(10);
      this->addChild(m_orbsHoverSprite);

      auto orbCount = CCLabelBMFont::create("8", "bigFont.fnt");
      orbCount->setID("orb-count");
      orbCount->setAnchorPoint({1.f, 0.f});
      orbCount->setRotation(90.0f);
      orbCount->setScale(0.5f);
      m_feedOrbsButton->addChild(orbCount);

      m_feedStarsButton = CCMenuItemSpriteExtra::create(
          EditorButtonSprite::createWithSpriteFrameName(
      ...
      m_feedStarsButton->setID("feed-stars");
      m_feedStarsButton->setPosition(topBarBG->getPositionX() - 20, topBarBG->getPositionY());
      topBarMenu->addChild(m_feedStarsButton);

      m_starsHoverSprite = CCSprite::createWithSpriteFrameName("GJ_starsIcon_001.png");
      m_starsHoverSprite->setVisible(false);
      m_starsHoverSprite->setID("stars-hover");
      m_starsHoverSprite->setZOrder(10);
      this->addChild(m_starsHoverSprite);

      m_starsLabel = CCLabelBMFont::create(numToString(m_starCount).c_str(), "bigFont.fnt");
      m_starsLabel->setID("star-count");
      m_starsLabel->setAnchorPoint({0.f, 0.f});
      m_starsLabel->setScale(0.5f);
      m_feedStarsButton->addChild(m_starsLabel);

      m_feedMoonsButton = CCMenuItemSpriteExtra::create(
          EditorButtonSprite::createWithSpriteFrameName(
      ...
      m_feedMoonsButton->setID("feed-moons");
      m_feedMoonsButton->setPosition(topBarBG->getPositionX() + 20, topBarBG->getPositionY());
      topBarMenu->addChild(m_feedMoonsButton);

      m_moonsHoverSprite = CCSprite::createWithSpriteFrameName("GJ_moonsIcon_001.png");
      m_moonsHoverSprite->setVisible(false);
      m_moonsHoverSprite->setID("moons-hover");
      m_moonsHoverSprite->setZOrder(10);
      this->addChild(m_moonsHoverSprite);

      m_moonsLabel = CCLabelBMFont::create(numToString(m_moonCount).c_str(), "bigFont.fnt");
      m_moonsLabel->setID("moon-count");
      m_moonsLabel->setAnchorPoint({0.f, 0.f});
      m_moonsLabel->setScale(0.5f);
      m_feedMoonsButton->addChild(m_moonsLabel);

      m_feedDiamondsButton = CCMenuItemSpriteExtra::create(
          EditorButtonSprite::createWithSpriteFrameName(
      ...
      m_feedDiamondsButton->setID("feed-diamonds");
      m_feedDiamondsButton->setPosition(topBarBG->getPositionX() + 62, topBarBG->getPositionY());
      topBarMenu->addChild(m_feedDiamondsButton);

      m_diamondsHoverSprite = CCSprite::createWithSpriteFrameName("GJ_diamondsIcon_001.png");
      m_diamondsHoverSprite->setVisible(false);
      m_diamondsHoverSprite->setID("diamonds-hover");
      m_diamondsHoverSprite->setZOrder(10);
      this->addChild(m_diamondsHoverSprite);

      m_diamondsLabel = CCLabelBMFont::create(numToAbbreviatedString(m_diamondCount).c_str(), "bigFont.fnt");
      m_diamondsLabel->setID("diamond-count");
      m_diamondsLabel->setAnchorPoint({0.f, 0.f});
      m_diamondsLabel->setScale(0.5f);
      m_feedDiamondsButton->addChild(m_diamondsLabel);

      m_diamondShardsLabel = CCLabelBMFont::create("-", "bigFont.fnt");
      m_diamondShardsLabel->setScale(0.65f);
      m_diamondShardsLabel->setID("money-count");
      ...
      m_moveModeButton = CCMenuItemSpriteExtra::create(
          EditorButtonSprite::createWithSpriteFrameName(
              "edit_areaModeBtn04_001.png",
              1.0f,
              EditorBaseColor::Gray,
              {}),
          this,
          menu_selector(ZenGardenLayer::onToggleMoveMode));
      m_moveModeButton->setID("move-mode-button");
      m_moveModeButton->setPosition(topBarBG->getPositionX() + 110, topBarBG->getPositionY());
      topBarMenu->addChild(m_moveModeButton);
      ...
      if (m_moveModeLabel) {
            ...
            m_moveModeLabel->setPosition({windowSize.width / 2, 50});
            m_moveModeLabel->setScale(0.7f);
            m_moveModeLabel->setAnchorPoint({0.5f, 1.f});
      ...
      if (!positionsStr.empty()) {
            ...
            while (std::getline(ss, token, ',')) {
                  ...
                  std::string key = "player_" + numToString(pos);
                  ...
                  int perMaturity = Mod::get()->getSavedValue<int>("player_maturity_" + numToString(pos), 0);
                  ...
                  playerItem->setID("purchased-player-" + numToString(pos));
                  ...
                  playerNode->setAnchorPoint({0.5f, 0.5f});
                  ...
                  if (!firstPlayerAssigned) {
                        ...
                        ZenGardenLayer::m_orbsFeeded = Mod::get()->getSavedValue<int>("player_orbs_fed_" + numToString(pos), 0);
                        ZenGardenLayer::m_lastOrbFeedTime = Mod::get()->getSavedValue<int64_t>("player_last_orb_feed_" + numToString(pos), 0);
      ...
      resetButton->setPosition({50, 25});
      resetButton->setID("reset-progress-button");
      buttonMenu->addChild(resetButton);

      auto toShopButton = ButtonSprite::create("Shop", "goldFont.fnt", "GJ_button_01.png", 0.8f);
      auto toShop = CCMenuItemSpriteExtra::create(
          toShopButton,
          this,
          menu_selector(ZenGardenLayer::onShop));

      toShop->setPosition({resetButton->getPositionX() + 90, 25});
      toShop->setID("shop-button");
      buttonMenu->addChild(toShop);
...
void ZenGardenLayer::onSimplePlayerClicked(CCObject* sender) {
      ...
      if (m_moveMode && clickedPos >= 0) {
            ...
            std::string playerName = Mod::get()->getSavedValue<std::string>("player_name_" + numToString(clickedPos), "");
      ...
      if (ZenGardenLayer::m_selectedItem != 0 && clickedPos >= 0) {
            ...
            int maturity = Mod::get()->getSavedValue<int>("player_maturity_" + numToString(clickedPos), 0);
            ...
            if (maturity < 1 && ZenGardenLayer::m_selectedItem == 1) {
                  if (canFeedOrbForPos(clickedPos)) {
                        int orbsFed = Mod::get()->getSavedValue<int>("player_orbs_fed_" + numToString(clickedPos), 0) + 1;
                        Mod::get()->setSavedValue<int>("player_orbs_fed_" + numToString(clickedPos), orbsFed);

                        auto currentTime = std::chrono::duration_cast<std::chrono::seconds>(
                                               std::chrono::system_clock::now().time_since_epoch())
                                               .count();
                        Mod::get()->setSavedValue<int64_t>("player_last_orb_feed_" + numToString(clickedPos), currentTime);

                        if (orbsFed >= 5) {
                              handlePlayerGrowthForPos(clickedPos);
                              maturity = Mod::get()->getSavedValue<int>("player_maturity_" + numToString(clickedPos), 0);
                        }
            ...
            // Level 1: Needs 5 stars with cooldown
                  ...
                  auto currentTime = std::chrono::duration_cast<std::chrono::seconds>(
                                         std::chrono::system_clock::now().time_since_epoch())
                                         .count();
                  int64_t lastFeed = Mod::get()->getSavedValue<int64_t>("player_last_star_feed_" + numToString(clickedPos), 0);
                  int required = 17 * (1 << 1);
                  if (currentTime - lastFeed >= required) {
                        if (ZenGardenLayer::m_starCount > 0) {
                              ...
                              int starsFed = Mod::get()->getSavedValue<int>("player_stars_fed_" + numToString(clickedPos), 0) + 1;
                              Mod::get()->setSavedValue<int>("player_stars_fed_" + numToString(clickedPos), starsFed);
                              Mod::get()->setSavedValue<int64_t>("player_last_star_feed_" + numToString(clickedPos), currentTime);
                        ...
                        std::string playerName = Mod::get()->getSavedValue<std::string>(
                            "player_name_" + numToString(clickedPos), "");
                        if (playerName.empty())
                              playerName = "Player";
            ...
            // Level 2: Needs 5 moons with cooldown
                  ...
                  auto currentTime = std::chrono::duration_cast<std::chrono::seconds>(
                                         std::chrono::system_clock::now().time_since_epoch())
                                         .count();
                  int64_t lastFeed = Mod::get()->getSavedValue<int64_t>("player_last_moon_feed_" + numToString(clickedPos), 0);
                  int required = 17 * (1 << 2);
                  if (currentTime - lastFeed >= required) {
                        if (ZenGardenLayer::m_moonCount > 0) {
                              ...
                              int moonsFed = Mod::get()->getSavedValue<int>("player_moons_fed_" + numToString(clickedPos), 0) + 1;
                              Mod::get()->setSavedValue<int>("player_moons_fed_" + numToString(clickedPos), moonsFed);
                              Mod::get()->setSavedValue<int64_t>("player_last_moon_feed_" + numToString(clickedPos), currentTime);
            ...
            // Level 3-4: Needs 5 diamonds per level with cooldown
                  ...
                  auto currentTime = std::chrono::duration_cast<std::chrono::seconds>(
                                         std::chrono::system_clock::now().time_since_epoch())
                                         .count();
                  int64_t lastFeed = Mod::get()->getSavedValue<int64_t>("player_last_diamond_feed_" + numToString(clickedPos), 0);
                  int required = 17 * (1 << levelForCooldown);
                  if (currentTime - lastFeed >= required) {
                        if (ZenGardenLayer::m_diamondCount > 0) {
                              ...
                              int diamondsFed = Mod::get()->getSavedValue<int>("player_diamonds_fed_" + numToString(clickedPos), 0) + 1;
                              Mod::get()->setSavedValue<int>("player_diamonds_fed_" + numToString(clickedPos), diamondsFed);
                              Mod::get()->setSavedValue<int64_t>("player_last_diamond_feed_" + numToString(clickedPos), currentTime);
            ...
            if (validFeed) {
                  ...
                  Mod::get()->setSavedValue<int>("money", m_diamondShards);
                  flashShards();
            ...
            m_selectedItem = 0;
            if (m_orbsHoverSprite)
                  m_orbsHoverSprite->setVisible(false);
            m_feedOrbsButton->setColor(ccc3(255, 255, 255));
            if (m_starsHoverSprite)
                  m_starsHoverSprite->setVisible(false);
            m_feedStarsButton->setColor(ccc3(255, 255, 255));
            if (m_moonsHoverSprite)
                  m_moonsHoverSprite->setVisible(false);
            m_feedMoonsButton->setColor(ccc3(255, 255, 255));
            if (m_diamondsHoverSprite)
                  m_diamondsHoverSprite->setVisible(false);
            m_feedDiamondsButton->setColor(ccc3(255, 255, 255));
            return;
      }
      ...
      if (clickedPos >= 0) {
            ...
            m_maturityLevel = Mod::get()->getSavedValue<int>("player_maturity_" + numToString(m_activePos), 0);
            m_orbsFeeded = Mod::get()->getSavedValue<int>("player_orbs_fed_" + numToString(m_activePos), 0);
            m_lastOrbFeedTime = Mod::get()->getSavedValue<int64_t>("player_last_orb_feed_" + numToString(m_activePos), 0);
            displayRequirementSprite();
      }

      if (ZenGardenLayer::m_simplePlayer) {
            int slotForPopup = m_activePos;
            if (auto playerInfo = SimplePlayerInfo::create(m_simplePlayer, slotForPopup)) {
                  playerInfo->show();
            }
      }
};
      ...
      if (!positionsStr.empty()) {
            ...
            while (std::getline(ss, token, ',')) {
                  ...
                  if (!firstPlayerAssigned) {
                        ...
                        m_orbsFeeded = Mod::get()->getSavedValue<int>("player_orbs_fed_" + numToString(pos), 0);
                        m_lastOrbFeedTime = Mod::get()->getSavedValue<int64_t>("player_last_orb_feed_" + numToString(pos), 0);
                        firstPlayerAssigned = true;
                  }
            }
      } else {
...
void ZenGardenLayer::onToggleMoveMode(CCObject* sender) {
      ...
      if (m_moveModeLabel) {
            ...
            m_moveModeButton->setColor(m_moveMode ? ccc3(100, 100, 100) : ccc3(255, 255, 255));
            if (!m_moveMode)
...
bool ZenGardenLayer::isSlotOccupied(int pos) {
      ...
      std::string token;
      while (std::getline(ss, token, ',')) {
            if (token == numToString(pos)) return true;
      }
      return false;
}
...
void ZenGardenLayer::movePlayerTo(int fromPos, int toPos) {
      ...
      auto moveStr = [&](const std::string& key) {
            std::string val = Mod::get()->getSavedValue<std::string>(key + numToString(fromPos), "");
            Mod::get()->setSavedValue<std::string>(key + numToString(toPos), val);
            Mod::get()->setSavedValue<std::string>(key + numToString(fromPos), "");
      };
      auto moveInt = [&](const std::string& key) {
            int val = Mod::get()->getSavedValue<int>(key + numToString(fromPos), 0);
            Mod::get()->setSavedValue<int>(key + numToString(toPos), val);
            Mod::get()->setSavedValue<int>(key + numToString(fromPos), 0);
      };
      auto moveI64 = [&](const std::string& key) {
            int64_t val = Mod::get()->getSavedValue<int64_t>(key + numToString(fromPos), 0);
            Mod::get()->setSavedValue<int64_t>(key + numToString(toPos), val);
            Mod::get()->setSavedValue<int64_t>(key + numToString(fromPos), 0);
      };
...
void ZenGardenLayer::sellPlayerAtPos(int pos) {
      ...
      // Compute payout
      int maturity = Mod::get()->getSavedValue<int>("player_maturity_" + numToString(pos), 0);
      ...
      // Clear per-slot data
      Mod::get()->setSavedValue<std::string>("player_" + numToString(pos), "");
      Mod::get()->setSavedValue<int>("player_maturity_" + numToString(pos), 0);
      Mod::get()->setSavedValue<int>("player_orbs_fed_" + numToString(pos), 0);
      Mod::get()->setSavedValue<int64_t>("player_last_orb_feed_" + numToString(pos), 0);
      Mod::get()->setSavedValue<int>("player_stars_fed_" + numToString(pos), 0);
      Mod::get()->setSavedValue<int>("player_moons_fed_" + numToString(pos), 0);
      Mod::get()->setSavedValue<int>("player_diamonds_fed_" + numToString(pos), 0);
      Mod::get()->setSavedValue<int64_t>("player_last_star_feed_" + numToString(pos), 0);
      Mod::get()->setSavedValue<int64_t>("player_last_moon_feed_" + numToString(pos), 0);
      Mod::get()->setSavedValue<int64_t>("player_last_diamond_feed_" + numToString(pos), 0);
      Mod::get()->setSavedValue<std::string>("player_name_" + numToString(pos), "");
      ...
      Notification::create("Sold " + soldPlayerName + " for " + numToString(payout), NotificationIcon::Success, 1.f)->show();
...
void ZenGardenLayer::stopMoveSelectionFlash() {
      ...
      std::string info = Mod::get()->getSavedValue<std::string>("player_" + numToString(flashedPos), "");
...
void ZenGardenLayer::applyOriginalColors(CCNode* node) {
      ...
      if (pos < 0) return;
      std::string info = Mod::get()->getSavedValue<std::string>("player_" + numToString(pos), "");
      if (info.empty()) {
            sp->setColor({255, 255, 255});
            return;
      }
...
void ZenGardenLayer::showBronzeCoinReward(int pos) {
      ...
      auto moveUp = CCMoveBy::create(2.0f, {0, 50});
...
void ZenGardenLayer::showSilverCoinReward(int pos) {
      ...
      auto moveUp = CCMoveBy::create(2.5f, {0, 60});
...
void ZenGardenLayer::showGoldCoinReward(int pos) {
      ...
      auto moveUp = CCMoveBy::create(3.0f, {0, 70});
      ...
      for (unsigned int i = 0; i < children->count(); ++i) {
            ...
            if (perMaturity < 1) {
                  ...
                  auto currentTime = std::chrono::duration_cast<std::chrono::seconds>(
                                         std::chrono::system_clock::now().time_since_epoch())
                                         .count();
                  int64_t last = Mod::get()->getSavedValue<int64_t>("player_last_star_feed_" + numToString(pos), 0);
                  int required = 17 * (1 << 1);
                  ...
                  auto currentTime = std::chrono::duration_cast<std::chrono::seconds>(
                                         std::chrono::system_clock::now().time_since_epoch())
                                         .count();
                  int64_t last = Mod::get()->getSavedValue<int64_t>("player_last_moon_feed_" + numToString(pos), 0);
                  int required = 17 * (1 << 2);
                  if (currentTime - last >= required)
                  ...
                  if (perMaturity >= 5) {
                        ...
                        int64_t last = Mod::get()->getSavedValue<int64_t>("player_last_diamond_feed_" + numToString(pos), 0);
                        int required = 17 * (1 << levelForCooldown);
                        if (currentTime - last >= required)
            ...
            if (icon) {
                  ...
                  if (perMaturity < 1) {
                        int orbsFed = Mod::get()->getSavedValue<int>("player_orbs_fed_" + numToString(pos), 0);
                        auto lbl = CCLabelBMFont::create((numToString(orbsFed) + "/5").c_str(), "goldFont.fnt");
                        lbl->setID("req-label");
                        lbl->setScale(0.3f);
                        lbl->setPosition({20.f, 10.f});
                        item->addChild(lbl, 500);
                  } else if (perMaturity < 2) {
                        int starsFed = Mod::get()->getSavedValue<int>("player_stars_fed_" + numToString(pos), 0);
                        auto lbl = CCLabelBMFont::create((numToString(starsFed) + "/5").c_str(), "goldFont.fnt");
                        lbl->setID("req-label");
                        lbl->setScale(0.3f);
                        lbl->setPosition({20.f, 10.f});
                        item->addChild(lbl, 500);
                  } else if (perMaturity < 3) {
                        int moonsFed = Mod::get()->getSavedValue<int>("player_moons_fed_" + numToString(pos), 0);
                        auto lbl = CCLabelBMFont::create((numToString(moonsFed) + "/5").c_str(), "goldFont.fnt");
                        lbl->setID("req-label");
                        lbl->setScale(0.3f);
                        lbl->setPosition({20.f, 10.f});
                        item->addChild(lbl, 500);
                  } else if (perMaturity < 5) {
                        int diamondsFed = Mod::get()->getSavedValue<int>("player_diamonds_fed_" + numToString(pos), 0);
                        auto lbl = CCLabelBMFont::create((numToString(diamondsFed) + "/5").c_str(), "goldFont.fnt");
                        lbl->setID("req-label");
                        lbl->setScale(0.3f);
                        lbl->setPosition({20.f, 10.f});
                        item->addChild(lbl, 500);
...
void ZenGardenLayer::handlePlayerGrowth() {
      ...
      if (m_maturityLevel < 5) {
            ...
            if (m_maturityLevel == 1) {
                  ...
                  m_orbsFeeded = 0;
                  if (m_activePos >= 0)
                        Mod::get()->setSavedValue<int>("player_orbs_fed_" + numToString(m_activePos), 0);
            } else if (m_maturityLevel == 2) {
                  // 1 -> 2 was STARs
                  if (m_activePos >= 0)
                        Mod::get()->setSavedValue<int>("player_stars_fed_" + numToString(m_activePos), 0);
                  else
                        Mod::get()->setSavedValue<int>("player_stars_fed", 0);
            } else if (m_maturityLevel == 3) {
                  // 2 -> 3 was MOONs
                  if (m_activePos >= 0)
                        Mod::get()->setSavedValue<int>("player_moons_fed_" + numToString(m_activePos), 0);
                  else
                        Mod::get()->setSavedValue<int>("player_moons_fed", 0);
            } else if (m_maturityLevel == 4 || m_maturityLevel == 5) {
                  // 3 -> 4 and 4 -> 5 are DIAMONDs
                  if (m_activePos >= 0)
                        Mod::get()->setSavedValue<int>("player_diamonds_fed_" + numToString(m_activePos), 0);
                  else
            ...
            if (m_activePos >= 0)
                  Mod::get()->setSavedValue<int>("player_maturity_" + numToString(m_activePos), m_maturityLevel);
            else
            ...
            // Show message
            std::string playerName = Mod::get()->getSavedValue<std::string>(
                "player_name_" + numToString(m_activePos), "");
            if (playerName.empty())
                  playerName = "Player";
            std::string message = playerName + " grew to maturity level " + numToString(m_maturityLevel) + "!";
...
void ZenGardenLayer::displayOrbCooldownMessage() {
      ...
      std::string message = "Please wait " + numToString(secondsRemaining) + " seconds.";
      // Prefix with active player's name if available
      std::string playerName;
      if (m_activePos >= 0)
            playerName = Mod::get()->getSavedValue<std::string>("player_name_" + numToString(m_activePos), "");
      if (playerName.empty())
            playerName = "Player";
...
void ZenGardenLayer::update(float dt) {
      ...
      ZenGardenLayer::m_starsLabel->setString(numToString(ZenGardenLayer::m_starCount).c_str(), true);
      ZenGardenLayer::m_moonsLabel->setString(numToString(ZenGardenLayer::m_moonCount).c_str(), true);
      ZenGardenLayer::m_diamondsLabel->setString(numToString(ZenGardenLayer::m_diamondCount).c_str(), true);
      ZenGardenLayer::m_diamondShardsLabel->setString((numToAbbreviatedString(ZenGardenLayer::m_diamondShards)).c_str(), true);
      ...
      if (m_diamondCurrencyIcon && m_diamondShardsLabel) {
            ...
            m_diamondCurrencyIcon->setPosition({m_diamondShardsLabel->getPositionX() - (labelWidth / 2) - 15, m_diamondShardsLabel->getPositionY()});
      }
            ...
            if (auto children = playersMenu->getChildren()) {
                  for (unsigned int i = 0; i < children->count(); ++i) {
                        ...
                        if (perMaturity == 0) {
                              ...
                              int orbsFed = Mod::get()->getSavedValue<int>("player_orbs_fed_" + numToString(pos), 0);
                              lbl->setString((numToString(orbsFed) + "/5").c_str(), true);
                              ...
                              int starsFed = Mod::get()->getSavedValue<int>("player_stars_fed_" + numToString(pos), 0);
                              lbl->setString((numToString(starsFed) + "/5").c_str(), true);
                        } else if (perMaturity == 2) {
                              auto currentTime = std::chrono::duration_cast<std::chrono::seconds>(
                                                     std::chrono::system_clock::now().time_since_epoch())
                                                     .count();
                              ...
                              int moonsFed = Mod::get()->getSavedValue<int>("player_moons_fed_" + numToString(pos), 0);
                              lbl->setString((numToString(moonsFed) + "/5").c_str(), true);
                              ...
                              int diamondsFed = Mod::get()->getSavedValue<int>("player_diamonds_fed_" + numToString(pos), 0);
                              lbl->setString((numToString(diamondsFed) + "/5").c_str(), true);
                        } else if (perMaturity >= 5) {
...
bool ZenGardenLayer::addRandomSimplePlayer() {
      ...
      std::string key = "player_" + numToString(freePosition);
      std::string playerInfo = numToString(randomIcon) + "," +
                               numToString(randomColor1) + "," +
                               numToString(randomColor2) + "," +
                               numToString(randomGlow);
      Mod::get()->setSavedValue<std::string>(key, playerInfo);

      // Initialize per-slot stats for the new player
      Mod::get()->setSavedValue<int>("player_maturity_" + numToString(freePosition), 0);
      Mod::get()->setSavedValue<int>("player_orbs_fed_" + numToString(freePosition), 0);
      Mod::get()->setSavedValue<int64_t>("player_last_orb_feed_" + numToString(freePosition), 0);
      Mod::get()->setSavedValue<int>("player_stars_fed_" + numToString(freePosition), 0);
      Mod::get()->setSavedValue<int>("player_moons_fed_" + numToString(freePosition), 0);
      Mod::get()->setSavedValue<int>("player_diamonds_fed_" + numToString(freePosition), 0);
      Mod::get()->setSavedValue<int64_t>("player_last_star_feed_" + numToString(freePosition), 0);
      Mod::get()->setSavedValue<int64_t>("player_last_moon_feed_" + numToString(freePosition), 0);
      Mod::get()->setSavedValue<int64_t>("player_last_diamond_feed_" + numToString(freePosition), 0);
...
void ZenGardenLayer::handlePlayerGrowthForPos(int pos) {
      ...
      if (maturity < 5) {
            ...
            Mod::get()->setSavedValue<int>("player_maturity_" + numToString(pos), maturity);
            ...
            Notification::create(playerName + " grew to maturity level " + numToString(maturity) + "!", NotificationIcon::Info, 1.f)->show();
      }
}
...
bool ZenGardenLayer::canFeedOrbForPos(int pos) {
      auto currentTime = std::chrono::duration_cast<std::chrono::seconds>(
                             std::chrono::system_clock::now().time_since_epoch())
                             .count();
      int64_t lastFeed = Mod::get()->getSavedValue<int64_t>("player_last_orb_feed_" + numToString(pos), 0);
